...
export namespace SniffTheWay
{
	...
	constexpr float UIWidth = static_cast<float>(DesignWidth);
	constexpr float UIHeight = static_cast<float>(DesignHeight);
	...
	// tried making this constexpr, but msvc produces corrupted code
	const glm::vec4 StoryTextColor{ 0.93f, 0.89f, 0.70f, 1.0f };
